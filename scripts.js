...
function colorModeToggle() {
    ...
    function updateChartColors(isDarkMode) {
        const textColor = getComputedStyle(document.documentElement)
            .getPropertyValue(isDarkMode ? '--dark--text' : '--color--text').trim(); // Assuming you have these CSS variables for text colors
        ...
        myChart.setOption(option, true); // Update the chart options
    }

    function goDark(dark, animate) {
        const isDarkMode = dark; // Assuming 'dark' is a boolean
        if (isDarkMode) {
        ...
        updateChartColors(isDarkMode); // Call this function to update chart colors
    ...
    window.addEventListener("DOMContentLoaded", (event) => {
        ...
        updateChartColors(document.documentElement.classList.contains("dark-mode"));
